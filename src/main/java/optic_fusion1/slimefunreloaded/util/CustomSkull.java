...
public class CustomSkull {
  ...
  private static Config CONFIG = Slimefun.getCfg();
  ...
  private static Object createProfile(String texture) throws Exception {
    ...
    Object profile = profile_constructor.newInstance(UUID.fromString(CONFIG.getString("skulls.uuids." + texture)), "SlimefunReloaded");
