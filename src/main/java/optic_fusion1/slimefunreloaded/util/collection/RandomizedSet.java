...
public class RandomizedSet<T> implements Iterable<T>, Streamable<T> {
  ...
  /**
   * This will initialize a new {@link RandomizedSet} with the internal Set being a {@link LinkedHashSet}
   */
  ...
  /**
   * This method updates an element with the given weight. The element must be contained in this Set before calling this method, otherwise an {@link IllegalStateException} will be thrown.
   *
  ...
  /**
   * This will create a random subset of unique elements from this Set. The selection is based on their weights.
   *
   * If the size you specify is bigger than the size of this Set, an {@link IllegalArgumentException} will be thrown.
   *
  ...
  /**
   * This method will provide an infinite {@link Stream} of elements, randomly drawn from this {@link RandomizedSet}.
   *
