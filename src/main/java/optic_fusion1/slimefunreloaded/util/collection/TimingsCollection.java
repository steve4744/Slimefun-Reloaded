...
public class TimingsCollection {
  ...
  /**
   * This method will add the current time in nanoseconds to the list. This operation is equal to <code>add(System.nanoTime())</code>
   */
  ...
  /**
   * This method will add the current time in milliseconds to the list. This operation is equal to <code>add(System.currentTimeMillis())</code>
   */
  ...
  /**
   * This method will give you the average interval between the recorded timestamps.
   *
  ...
  /**
   * This method will give you the maximum interval between the recorded timestamps.
   *
  ...
  /**
   * If you are not storing timestamps but instead store the intervals themselves, then use this method to get the average of all stored values.
   *
  ...
  /**
   *
   * If you are not storing timestamps but instead store the intervals themselves, then use this method to get the maximum of all stored values.
   *
