...
public final class MinecraftAccount {
  ...
  /**
   * This method returns an Optional for a Player's UUID. The Player has to have a Minecraft account but doesn't have to have ever played on the current server. This will perform a blocking web request, so it should never be run on the main thread. If there is no Player with the given name, the Optional will be empty.
   *
   ...
   */
  public static Optional<UUID> getUUID(String name) throws TooManyRequestsException {
   ...
   * The Player has to have a Minecraft account but doesn't have to have ever played on the current server. 
   * This will perform a blocking web request, so it should never be run on the main thread.
   ...
   * @throws TooManyRequestsException	If too many requests were sent to the Server
   */
  public static Optional<String> getSkin(UUID uuid) throws TooManyRequestsException {
