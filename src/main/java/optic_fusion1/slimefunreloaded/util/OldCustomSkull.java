...
//    Object profile = null;
//    try {
//      profile = ReflectionUtils.getValue(item.getItemMeta(), "profile");
...
//    }
//    try {
//      return getOwner.invoke(ReflectionUtils.getValue(item.getItemMeta(), "profile"));
//    } catch (Exception e) {
//      return "CSCoreLib";
//    }
//  }
