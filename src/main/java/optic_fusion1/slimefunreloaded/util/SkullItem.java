...
public final class SkullItem {
   ...
   *
   * The specified UUID should be shared for this specific URL, if you use {@link UUID#randomUUID()} for this, then your Heads may not be stackable. You should probably store and re-use these UUIDs somewhere.
   *
  ...
  /**
   * This will call {@link SkullItem#fromBase64(UUID, String)} and use an instance of {@link UUID} that was generated from the provided texture using {@link String#getBytes()}
   *
   * @param texture	The Base64 representation of your Texture
   * @return	A new Player Head with the Texture you specified
   */
  ...
  /**
   * This Method will return a Custom Player Head with the Texture specified. This method will simply call {@link SkullItem#fromURL(UUID, String)} and prepend the default minecraft.net skin url.
   *
   * The specified UUID should be shared for this specific URL, if you use {@link UUID#randomUUID()} for this, then your Heads may not be stackable. You should probably store and re-use these UUIDs somewhere.
   *
   * @param uuid	The UUID for the fake Profile that is created
  ...
  /**
   * This will call {@link SkullItem#fromTextureID(UUID, String)} and use an instance of {@link UUID} that was generated from the provided texture using {@link String#getBytes()}
   *
   * @param texture	The texture for your Player
   * @return	A new Player Head with the Texture you specified
   */
  ...
  /**
   * This Method will return a Custom Player Head with the Texture found in the URL. Note that it should be a minecraft.net URL, otherwise this may not work.
   *
   * The specified UUID should be shared for this specific URL, if you use {@link UUID#randomUUID()} for this, then your Heads may not be stackable. You should probably store and re-use these UUIDs somewhere.
   *
   * @param uuid	The UUID for the fake Profile that is created
  ...
  /**
   * This will call {@link SkullItem#fromURL(UUID, String)} and use an instance of {@link UUID} that was generated from the provided texture using {@link String#getBytes()}
   *
   * @param url	The URL to your Texture
   * @return	A new Player Head with the Texture you specified
   */
  ...
  /**
   * This Method returns the Player Head for a specific Player Name. IMPORTANT: This Method will make a Web Request to Mojang to look up the Player Texture. You should definitely perform this action asynchronously.
   *
