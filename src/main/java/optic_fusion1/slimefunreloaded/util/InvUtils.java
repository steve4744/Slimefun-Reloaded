...
import optic_fusion1.slimefunreloaded.inventory.ChestMenu.MenuClickHandler;
...
//  public static final MenuClickHandler EMPTY_CLICK = (p, slot, item, cursor, action) -> false;
  ...
  /**
   * This method checks if an Item can fit into the specified slots. Note that this also checks {@link ItemStack#getAmount()}
   *
  ...
  /**
   * This method removes a given amount of items from a given {@link Inventory} if they pass the given {@link Predicate}
   *
