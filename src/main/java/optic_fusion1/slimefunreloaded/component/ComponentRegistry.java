...
public final class ComponentRegistry {
  ...
  public static void registerComponents() {
    ...
    register(new Vitamins(new NamespacedKey(plugin, "vitamins"), WEAPONS, (SlimefunReloadedItemStack) SlimefunReloadedItems.VITAMINS, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {SlimefunItems.CAN, new ItemStack(Material.APPLE), new ItemStack(Material.RED_MUSHROOM), new ItemStack(Material.SUGAR), null, null, null, null, null}));
