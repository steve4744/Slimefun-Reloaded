...
public final class ComponentRegistry {
  ...
  public static void registerComponents() {
    ...
    registerBackpack("backpack_cooler", PORTABLE, (SlimefunReloadedItemStack) SlimefunReloadedItems.COOLER, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{SlimefunReloadedItems.CLOTH, SlimefunReloadedItems.CLOTH, SlimefunReloadedItems.CLOTH, SlimefunReloadedItems.ALUMINUM_INGOT, SlimefunReloadedItems.COOLING_UNIT, SlimefunReloadedItems.ALUMINUM_INGOT, SlimefunReloadedItems.ALUMINUM_INGOT, SlimefunReloadedItems.ALUMINUM_INGOT, SlimefunReloadedItems.ALUMINUM_INGOT});
    ...
    Category MAGIC_ARMOR = CATEGORY_MANAGER.getCategoryByName("MagicArmor");
    ...
    //TECH_MISC Registery
    Category TECH_MISC = CATEGORY_MANAGER.getCategoryByName("TechMisc");
    ...
    registerSimpleSlimefunReloadedItem("stone_chunk", MISC, (SlimefunReloadedItemStack) SlimefunReloadedItems.STONE_CHUNK, RecipeType.ORE_WASHER, new ItemStack[]{SlimefunReloadedItems.SIFTED_ORE, null, null, null, null, null, null, null, null});
