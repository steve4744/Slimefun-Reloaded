...
public class CategoryRegistery {
  ...
  public void registerCategories() {
    ItemStack weapons = new ItemStackBuilder(Material.GOLDEN_SWORD).setName("&7Weapons").addLore("").addLore(LORE).asBukkitItemStack();
    ...
    ItemStack food = new ItemStackBuilder(Material.APPLE).setName("&7Food").addLore("").addLore(LORE).asBukkitItemStack();
    Category foodCategory = new Category("Food", food, 2);
    register(foodCategory);
    ItemStack machines = new ItemStackBuilder(Material.SMITHING_TABLE).setName("&7Basic Machines").addLore("").addLore(LORE).asBukkitItemStack();
...
//	public static final LockedCategory GPS = new LockedCategory(new CustomItem(SlimefunReloadedItems.GPS_TRANSMITTER, "&bGPS-based Machines", "", LORE), 4, MACHINES_1);
    ItemStack armor = new ItemStackBuilder(Material.IRON_CHESTPLATE).setName("&7Armor").addLore("").addLore(LORE).asBukkitItemStack();
...
//    	public static final Category LUMPS_AND_MAGIC = new Category(new CustomItem(SlimefunReloadedItems.RUNE_ENDER, "&7Magical Items", "", LORE), 2);
    ItemStack magic = new ItemStackBuilder(Material.ELYTRA).setName("&7Magical Gadgets").addLore("").addLore(LORE).asBukkitItemStack();
    ...
    ItemStack tech = new ItemStackBuilder(Material.LEATHER_CHESTPLATE)/*.setColor(Color.SILVER)*/.setName("&7Technical Gadgets").addLore("").addLore(LORE).asBukkitItemStack();
...
//	public static final Category MAGIC_ARMOR = new Category(new CustomItem(SlimefunReloadedItems.ENDER_HELMET, "&7Magical Armor", "", LORE), 2);
    ItemStack talismans_1 = new ItemStackBuilder(Material.EMERALD).setName("&7Talismans - &aTier I").addLore("").addLore(LORE).asBukkitItemStack();
    Category talismans_1Category = new Category("Talismans I", talismans_1, 2);
    register(talismans_1Category);
    ItemStack talismans_2 = new ItemStackBuilder(Material.EMERALD).setName("&7Talismans - &aTier II").addLore("").addLore(LORE).asBukkitItemStack();
    ...
    ItemStack tools = new ItemStackBuilder(Material.GOLDEN_PICKAXE).setName("&7Tools").addLore("").addLore(LORE).asBukkitItemStack();
